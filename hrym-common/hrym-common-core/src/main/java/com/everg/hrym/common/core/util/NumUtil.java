...
public class NumUtil {
     ...
     * @param total
     */
    public static String getPercentForWechat(double num, double total) {
     ...
     * @param total
     */
    public static String getPercent1(double num, double total) {
    ...
    public static void main(String[] args) {
        System.out.println(getTotalNumStr(23455666666.00,"0"));
    }
}
